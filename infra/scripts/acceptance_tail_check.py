...
def check_static_docs() -> None:
    ...
    for needle in (
        ...
        "first_usable_release_report.py --first-usable --env-file .env.production",
    ...
    for needle in (
        ...
        "next_actions",
        "build_next_actions",
        "production_env_inputs",
        "production_env_target",
        "missing_or_placeholder_env_keys",
        "provider_canary_live_calls",
        "ocr_provider_live_check",
        "final_first_usable_report",
        "--first-usable",
        "first_usable_mode",
        "apply_first_usable_mode",
        "--include-repo-check",
    ...
    for needle in (
        ...
        "test_blocked_canary_json_outputs_are_written_when_production_env_audit_fails",
    ...
    for needle in (
        ...
        "test_first_usable_mode_implies_full_production_evidence_bundle",
        "test_repo_wide_check_does_not_inherit_loaded_production_env",
        "test_next_actions_explain_remaining_production_inputs",
